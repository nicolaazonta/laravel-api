...
<body>
    <div id="app">
       {{--  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="{{route('admin.projects.index')}}">BoolPress</a>
        ...
        <ul class="nav justify-content-end flex-sm-column sticky-top nav-dark sticky-top  shadow">
            <li class="nav-item">
                <a class="nav-link" href="{{route('admin.projects.index')}}" aria-current="page"><i class="fa fa-home" aria-hidden="true"></i></a>
            </li>
            {{-- <li class="nav-item">
